...
class DailyNews(Base):
    ...
    __table_args__ = (
        UniqueConstraint("news_id", name="uq_daily_news_id_unique"),  # Unique constraint for foreign-key references
...
class DailyTopic(Base):
    ...
    __table_args__ = (
        UniqueConstraint("topic_id", name="uq_daily_topics_id_unique"),  # Unique constraint for foreign-key references
