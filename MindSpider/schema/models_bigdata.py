"""
Public-opinion big-data aggregate primary table ORM models
(auto-synced from the original tables.sql structure, used for large-scale search and content ingestion)

Data model definition locations:
- MindSpider/DeepSentimentCrawling/MediaCrawler/schema/tables.sql  # Source of primary table structures
- This module (auto-mapped SQL tables for MySQL/PostgreSQL; comments and unique/index constraints can be manually refined)
- MindSpider/schema/models_sa.py  # Base definition source

This module follows MindSpider\DeepSentimentCrawling\MediaCrawler\database\models.py as the reference.
"""

from sqlalchemy.orm import Mapped, mapped_column
from sqlalchemy import Integer, String, BigInteger, Text, ForeignKey

# Use Base from models_sa so all tables share one metadata and foreign-key references work correctly
