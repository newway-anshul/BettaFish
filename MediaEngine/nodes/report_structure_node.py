...
Responsible for generating the overall report structure from a query
"""
...
class ReportStructureNode(StateMutationNode):
    ...
    def run(self, input_data: Any = None, **kwargs) -> List[Dict[str, str]]:
        """
        Call the LLM to generate report structure
        
        Args:
            input_data: Input data (unused here; the initialized query is used)
    ...
    def _generate_default_structure(self) -> List[Dict[str, str]]:
        """
        Generate a default report structure
        ...
        return [
            ...
            },
            {
                ...
                "content": "Analyze the different aspects of the query topic in depth"
            }
        ]
    
    def mutate_state(self, input_data: Any = None, state: State = None, **kwargs) -> State:
        """
        Write the report structure into state
