...
class Search:
    ...
    content: str = ""                  # Returned content
    score: Optional[float] = None      # Relevance score
    paragraph_title: str = ""          # Paragraph title for attribution
    search_tool: str = ""              # Search tool used
    has_result: bool = True            # Whether a result was returned
...
class Research:
    ...
    latest_summary: str = ""                                       # Latest paragraph summary
    ...
    def add_search_results(self, query: str, results: List[Dict[str, Any]], search_tool: str = "", paragraph_title: str = ""):
        ...
        if not results:
            # Record one "no result" search for frontend trace display
            self.add_search(
                Search(
                    query=query or "",
