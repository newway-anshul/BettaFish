...
class LLMClient:
    ...
    def stream_invoke(self, system_prompt: str, user_prompt: str, **kwargs) -> Generator[str, None, None]:
        """
        Call the LLM in streaming mode and yield the response incrementally
    ...
    def stream_invoke_to_string(self, system_prompt: str, user_prompt: str, **kwargs) -> str:
        """
        Call the LLM in streaming mode and safely assemble a full string
        while avoiding UTF-8 multibyte character truncation
        ...
        # Join all bytes, then decode once
        if byte_chunks:
