...
class LLMClient:
    ...
    def invoke(self, system_prompt: str, user_prompt: str, **kwargs) -> str:
        ...
        time_prefix = f"Current actual time is {current_time}"
        if user_prompt:
    ...
    def stream_invoke(self, system_prompt: str, user_prompt: str, **kwargs) -> Generator[str, None, None]:
        """
        Stream-call the LLM and return response content incrementally.
    ...
    def stream_invoke_to_string(self, system_prompt: str, user_prompt: str, **kwargs) -> str:
        """
        Stream-call the LLM and safely concatenate into a full string
        (avoids truncating UTF-8 multi-byte characters).
