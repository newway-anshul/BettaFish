...
class FirstSearchNode(BaseNode):
    """Node that generates the first search query for a paragraph"""
    ...
    def run(self, input_data: Any, **kwargs) -> Dict[str, str]:
        ...
        try:
            if not self.validate_input(input_data):
                raise ValueError("Invalid input format: title and content fields are required")
...
class ReflectionNode(BaseNode):
    ...
    def run(self, input_data: Any, **kwargs) -> Dict[str, str]:
        ...
        try:
            if not self.validate_input(input_data):
                raise ValueError("Invalid input format: title, content, and paragraph_latest_state fields are required")
    ...
    def _get_default_reflection_query(self) -> Dict[str, str]:
        ...
        """
        return {
            "search_query": "supplementary information for deep research",
