...
Formats final research results into a readable Markdown report.
"""
...
class ReportFormattingNode(BaseNode):
    ...
    def process_output(self, output: str) -> str:
        ...
        try:
            ...
            # Add a default title when missing.
        ...
        try:
            ...
            if len(paragraphs_data) > 1:
                report_lines.extend([
                    ...
                    " The content above offers important reference points for understanding this topic.",
                    ""
                ])
